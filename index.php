  ...
  <?php
    ...
    while($data_siswa=mysqli_fetch_array($query)){?>
        <tr>
            ...
            <td><?php   
            QRcode::png("Nama Barang: " .$data_siswa['namabarang']."\n"
            ."Spesifikasi Barang ini :  " .$data_siswa['spesifikasi']."\n"
            ."Jenis Barang Ini adalah " .$data_siswa['jenis']."\n"
            ."Jumlah Barang ini Di SMK TARUNA BHAKTI ada " .$data_siswa['jumlah']."\n"
            ."Sarana Ini berada Di " .$data_siswa['lokasi'], "appbener/barang".$data_siswa['namabarang'].".png","H",1,1);
